...
!(function (t, e) {
  ...
  function dt(t) {
    return (
      ...
      (pt && t instanceof Blob) ||
      (lt && t instanceof File)
    );
  }
  function yt(e, n) {
  ...
  function xt(e, n) {
    ...
    return (
      n.forceNew || n["force new connection"] || !1 === n.multiplex || c
        ? (r = new Nt(i, n))
        : (Bt[s] || (Bt[s] = new Nt(i, n)), (r = Bt[s])),
      o.query && !n.query && (n.query = o.queryKey),
      r.socket(o.path, n)
    );
  }
  return o(xt, { Manager: Nt, Socket: Ot, io: xt, connect: xt }), xt;
});
